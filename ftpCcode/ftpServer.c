...
SPLArray_char* process_string (SPLArray_char* thing) {
  ...
  tmp_17 = newSPLArray_char( ((thing->length) + 1));
  out = tmp_17;
  (out->arr[0]) = ((char) 0);
